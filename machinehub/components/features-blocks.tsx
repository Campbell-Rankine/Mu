export default function FeaturesBlocks() {
  return (
    <section className="relative bg-primary pb-24">

      {/* Section background (needs .relative class on parent and next sibling elements) */}
      
      <div className="spacer stackWave">
      <div className="spacer waveTop">
      <div className="absolute inset-0 top-1/2 md:mt-12 lg:mt-0 bg-primary opacity-80 pointer-events-none" aria-hidden="true"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-12 sm:px-6">
        ...
        <div className="py-12 md:py-20">
          ...
          {/* Section header */}
          <div className="max-w-4xl mx-auto text-center pb-5 md:pb-10">
            <h2 className="h2 font-extrabold pt-10 text-5xl mb-48">Explore the solutions</h2>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-4 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            {/* 1st item */}
            <div className="relative flex flex-col items-center p-6 bg-gray-100 rounded shadow-xl hover:text-greens-300 hover:opacity-95">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Model Distillation</h4>
              <p className="text-gray-600 text-center">Reduce the inference time of your models with our distillation toolkit</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-gray-100 rounded shadow-xl hover:text-greens-300 hover:opacity-95">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Hyper-parameter Search</h4>
              <p className="text-gray-600 text-center">Track Experiments and optimize the performance of your model</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-gray-100 rounded shadow-xl hover:text-greens-300 hover:opacity-95">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Upsampling / Super Resolution</h4>
              <p className="text-gray-600 text-center">Increase the resolution of your photos as part of the vision toolkit.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-gray-100 rounded shadow-xl hover:text-greens-300 hover:opacity-95">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Document QA</h4>
              <p className="text-gray-600 text-center">Explore different models with our integrated AI deployments.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-gray-100 rounded shadow-xl hover:text-greens-300 hover:opacity-95">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">AI Security</h4>
              <p className="text-gray-600 text-center">Protect your company with our prompt injection filter and other AI security tools.</p>
            </div>
