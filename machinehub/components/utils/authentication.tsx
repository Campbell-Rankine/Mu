...
export function GitHubSignUpButton() {
  ...
  return (
    <div className="gSignIn right-72 pr-4">
                  <button className={`btn px-0 text-white bg-gray-900 hover:bg-gray-800 w-full relative flex items-center ${currentAuth ? 'opacity-0' : ''}`} onClick={gitHubSignUp}>
...
export function GoogleSignUpButton() {
  ...
  return (
    <div className="gSignIn right-4 pt-2 pb-2 pr-2">
                  <button className={`btn px-0 text-white bg-red-600 hover:bg-red-700 w-full relative flex items-center ${currentAuth ? 'opacity-0' : ''}`} onClick={googleSignUp}>
                    <svg className="w-4 h-4 fill-current text-white opacity-75 shrink-0 mx-4" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
...
export function AccountInfoCard() {
  ...
  return (
    <div className={`gSignIn right-4 pt-2 pb-2 pr-2 ${currentAuth ? "opacity-80" : "opacity-0"}`}>
